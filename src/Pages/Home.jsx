...
{/*<!-- sidebar cart - start
            ...
            <div className="sidebar-menu-wrapper">
                <div className="cart_sidebar">
                    ...
                    <ul className="btns_group ul_li_block clearfix">
                        <li><a className="btn btn_primary" href="cart.html">View Cart</a></li>
                        <li><a className="btn btn_secondary" href="checkout.html">Checkout</a></li>
                    </ul>
                </div>
            ...
            ================================================== --> */}
            <div className="modal fade" id="quickview_popup" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalToggleLabel2">Product Quick View</h5>
                                        ...
                                        <div className="col-lg-6">
                                            <div className="product_details_content">
                                                ...
                                                <ul className="default_btns_group ul_li">
                                                    <li><a className="addtocart_btn" href="./cart.html">Add To Cart</a></li>
              ...
              {slides.map(slide => (
                <div key={slide.id} className={`slider_item ${slide.bgClass}`}>
                  <div className="slider_content">
                    <h3 className="small_title" data-animation="fadeInUp2" data-delay=".2s">{slide.smallTitle}</h3>
                    <h4 className="big_title" data-animation="fadeInUp2" data-delay=".4s">
                      {slide.bigTitle.split(' ').map((word, index) => (
                        <React.Fragment key={index}>
                          {word}{index === 1 && <span> </span>}
                        </React.Fragment>
                      ))}
                    </h4>
                    <p data-animation="fadeInUp2" data-delay=".6s">{slide.description}</p>
                        ...
                        <div className="col-lg-9 order-lg-3">
                            <div className="best-selling-products">
                                <div className="sec-title-link">
                                    <h3>Best selling</h3>
                                    <div className="view-all"><a href="#">View all<i className="fal fa-long-arrow-right"></i></a></div>
                                </div>
                                    ...
                                    <div className="grid">
                                        <div className="product-pic">
                                            ...
                                            <div className="actions">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a className="quickview_btn" data-bs-toggle="modal" href="#quickview_popup" role="button" tabindex="0"><svg width="48px" height="48px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#2329D6" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" fill="none" color="#2329D6"> <title>Visible (eye)</title> <path d="M22 12C22 12 19 18 12 18C5 18 2 12 2 12C2 12 5 6 12 6C19 6 22 12 22 12Z"/> <circle cx="12" cy="12" r="3"/> </svg></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div className="details">
                                            ...
                                            <div className="add-cart-area">
                                                <button className="add-to-cart" href="./cart.html">Add to cart</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="grid">
                            ...
                            <div className="product-sidebar">
                                ...
                                <div className="widget product-add">
                                    ...
                                    <div className="details">
                                        ...
                                        <a className="btn btn_primary" href="#" >Start Buying</a>
                                    </div>
                                </div>
                    ...
                    <div className="row promotion_banner_wrap">
                        <div className="col col-lg-6">
                            <div className="promotion_banner">
                                ...
                                <div className="item_content">
                                    <h3 className="item_title">Protective sleeves <span>combo.</span></h3>
                                    <p>It is a long established fact that a reader will be distracted</p>
                                    <a className="btn btn_primary" href="shop_details.html">Shop Now</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col col-lg-6">
                            <div className="promotion_banner">
                                ...
                                <div className="item_content">
                                    <h3 className="item_title">Nutrillet blender <span>combo.</span></h3>
                                    <p>
                        ...
                        <div className="col col-lg-5">
                            <div className="deals_product_layout1">
                                <div className="bg_area">
                                    <h3 className="item_title">Best <span>Product</span> Deals</h3>
                                    <p>
            ...
            <section className="viewed_products_section section_space">
                <div className="container">
                    ...
                    <div className="viewed_products_wrap arrows_topright">
                        <div className="viewed_products_carousel row" data-slick='{"dots": false}'>
                        ...
                        <div className="carousel_nav">
                            <button type="button" className="vpc_left_arrow"><i className="fal fa-long-arrow-alt-left"></i></button>
                            <button type="button" className="vpc_right_arrow"><i className="fal fa-long-arrow-alt-right"></i></button>
                        </div>
                    </div>
                </div>
            </section>
           
            <section className="newsletter_section" style={{backgroundColor: 'blue',}}>
                <div className="container">
                        ...
                        <div className="col col-lg-6">
                            <form action="#!">
                                <div className="newsletter_form">
                                    ...
                                    <button type="submit" className="btn btn_secondary" style={{backgroundColor: 'rgb(4, 4, 104)'}}>Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
