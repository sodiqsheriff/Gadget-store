...
export const ProductCard = (props) => {
  const { productData: product, onProductClick } = props;

  return (
    <div key={props.ProductId} className="grid">
      <div className="product-pic">
        <img src={props.productImage} style={{ height: "200px" }} alt="" />
      ...
      <div className="details">
        ...
        <p>
          <a href="#">{props.productDescription}</a>
        </p>
