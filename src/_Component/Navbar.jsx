    ...
    <>
      ...
      {visible && (
        <div className="card card-body h-100" >
          <ul className="allcategories_list ul_li_block" style={{ backgroundColor: 'green', position: 'absolute', zIndex: 1, overflow: 'scroll', height: '200px' }}>
            <li>
              <a href="shop_grid.html">
                <i className="icon icon-Starship"></i> New Arrival Products
              </a>
            </li>
            <li>
              <a href="shop_list.html">
                <i className="icon icon-WorldWide"></i> Most Popular Products
              </a>
            </li>
            <li>
              <a href="shop_grid.html">
            ...
            <li>
              <a href="shop_grid.html">
                <i className="icon icon-DesktopMonitor"></i> Computer Accessories
              </a>
            </li>
            <li>
              <a href="shop_list.html">
            ...
            <li>
              <a href="shop_grid.html">
                <i className="icon icon-Car"></i> Automobiles & Motorcycles
              </a>
            </li>
          </ul>
        </div>
