              ...
              <Row className="align-items-center">
                <Col lg={3} md={3} sm={12}>
                  <div className="brand_logo">
                    ...
                    >
                      <img src={logo} srcSet="assets/images/logo/logo_2x.png 2x" style={{ height: '3em' }} alt="" />
                      <h1
                        style={{
                          color: "black",
                          fontWeight: "bold",
                ...
                <Col lg={3} md={3} sm={12}>
                  ...
                  <button type="button" className="cart_btn" style={{backgroundColor: 'white', border: 'none',}}>
                            ...
                            <nav className="main_menu navbar navbar-expand-lg">
                                <div className="main_menu_inner collapse navbar-collapse" id="main_menu_dropdown">
                                    ...
                                    <ul className="main_menu_list ul_li">
                                        <li className="">
                                            <a className="nav-link" href="#" id="shop_submenu" >Home</a>  
                                        </li>
                                        <li className="dropdown">
                                            <a className="nav-link" href="#" id="shop_submenu" role="button" >Shop</a>
                                        ...
                                        <li className="dropdown">
                                            ...
                                            <ul className="submenu dropdown-menu" aria-labelledby="pages_submenu">
                                                ...
                                                <li><a href="register.html" style={{backgroundColor: '#2563EB', color: 'white'}}>Register</a></li>
                                                <li className="dropdown">
